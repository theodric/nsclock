...
destStation1 = "Rotterdam Centraal"
destStation2 = "Den Haag Centraal"
         ...
         if args.content:
            for iterCount in range(30):
                ...
                if (dest == destStation1 and numDisplayed <= 3) or (dest == destStation2 and numDisplayed <= 3):
                    ...
                    if dest == "Rotterdam Centraal":
                        dest = "RTD"
                        print("!! HIT") ## flagging matches on CLI for debug
                    elif dest == "Den Haag Centraal":
                        dest = "GVC"
                        print("!! HIT") ## flagging matches on CLI for debug
...
#                    dest = str(dest)
                    ...
                    text.AddText(disp, 5, 19, 16, Id="opt1")
                    ...
                    if disp2_exists == True:
                        text.AddText(disp2, 5, 39, 16, Id="opt2")
                    ...
                    if disp3_exists == True:
                        text.AddText(disp3, 5, 59, 16, Id="opt3")
                    ...
                    if disp4_exists == True:
                        text.AddText(disp3, 5, 79, 16, Id="opt4")
